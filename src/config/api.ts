...
// Webhook untuk hapus riwayat
const WEBHOOK_HAPUS_RIWAYAT_STOK = import.meta.env.VITE_N8N_WEBHOOK_HAPUS_RIWAYAT_STOK;
const WEBHOOK_HAPUS_RIWAYAT_PENJUALAN = import.meta.env.VITE_N8N_WEBHOOK_HAPUS_RIWAYAT_PENJUALAN;
const WEBHOOK_HAPUS_RIWAYAT_PEMBELIAN = import.meta.env.VITE_N8N_WEBHOOK_HAPUS_RIWAYAT_PEMBELIAN;
...
warnMissingEnv("VITE_N8N_WEBHOOK_HAPUS_RIWAYAT_STOK", WEBHOOK_HAPUS_RIWAYAT_STOK);
warnMissingEnv("VITE_N8N_WEBHOOK_HAPUS_RIWAYAT_PENJUALAN", WEBHOOK_HAPUS_RIWAYAT_PENJUALAN);
warnMissingEnv("VITE_N8N_WEBHOOK_HAPUS_RIWAYAT_PEMBELIAN", WEBHOOK_HAPUS_RIWAYAT_PEMBELIAN);
...
export const API_ENDPOINTS = {
  ...
  hapusRiwayatStok: WEBHOOK_HAPUS_RIWAYAT_STOK,
  hapusRiwayatPenjualan: WEBHOOK_HAPUS_RIWAYAT_PENJUALAN,
  hapusRiwayatPembelian: WEBHOOK_HAPUS_RIWAYAT_PEMBELIAN,
} as const;
